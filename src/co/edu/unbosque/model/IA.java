 ...
 * 
 *         Se enumeran las posiciones del tablero de triqui de la siguiente
 *         manera: | 1 | | 2 | | 3 | | 4 | | 5 | | 6 | | 7 | | 8 | | 9 | Cuando
 *         el jugador da clic en uno de los botones de la posición le envia el
 *         número de posición a esta clase (con interfaz gráfica) La celdas
 *         esquineras son: 1,3,7,9 estos valores se guardan en el vector
 *         esquina[][] la celdas de los lados son: 2,4,6,8 estos valores se
 *         guardan en el vector lado[][] la celda central es la numero 5 este
 *         valor se guarda en la variable centro las esquinas vecinas a los
 *         lados son: lado 2 --> celdas 1,3 lado 4 --> celdas 1,7 lado 6 -->
 *         celdas 3,9 lado 8 --> celdas 7,9 Estos valores se utlizan para
 *         seleccionar la estrategia a seguir. Se tienen tres estrategias de
 *         defensa y una estrategia de ataque. Estrategia de defensa: 1.si el
 *         jugador juega en una celda esquinera, la cpu debe seleccionar el
 *         centro del tablero 2.Si el jugador selecciona una casilla de lado del
 *         tablero la cpu puede seleccioanr cualquier esquina vecina del lado
 *         seleccionado 3.El programa debe identificar las filas o columnas en
 *         las que el jugador pueda hacer triqui y jugar para evitarlo
 *         Estrategia de ataque: 1.Estrategia de ataque: Consiste en identifcar
 *         las filas o columnas en la que la cpu puede completar el triqui.para
 *         esto se utliza el metodo llamado estanAtacando().
 *
 */
public class IA {
	private int resultado = 0;/*
								 * la variable resultado se usa para verificar si es ganador el cpu, no gano el
								 * cpu o es empate.
								 */
	...
	private int juegaCpu, juegaCpu1, juegaCpu2, juegaCpu3, juegaCpu4;
	private int triquit = 0;

	/**
	 * @author Carlos Albarracín
	 * @return Estos bucles revisan todas las columnas y filas en donde exista la
	 *         posibilidad de que la cpu haga triqui Si la suma de las filas es
	 *         igual a 4 indica que hay posibilidades de hacer triqui.Esto teniendo
	 *         encuenta que cuando juega la cpu coloca un dos en la posicion de la
	 *         matriz jugada
	 */
	 ...
	 * @author Carlos Albarracín
	 */
	public int defender(int ordenJugada, int p1, int p2, int p3, int p4,int cpu1,int cpu2,int cpu3) {
		...
		// Esta matriz se utiliza para encotrar la estrategia, en el caso de que la
		// primera jugada sea una esquina del tablero
		esquina[0] = 1;
		esquina[1] = 3;
		esquina[2] = 7;
		esquina[3] = 9;
		...
		// Esta matriz se utiliza para encotrar la estrategia2, en el caso de que la
		// primera jugada sea un lado del tablero
		lados[0] = 2;
		lados[1] = 4;
		lados[2] = 6;
		lados[3] = 8;
...
//	        ============================================= La segunda jugada =============================================
		...
		if (ordenJugada == 2) {
			...
			// jugada
			// de manera, que la cpu juegue en la celda que evita el triqui. La celda
			// elijidad por le jugador se almacena 1 en la matriz jugada[][].
